...
#define _SD_OK              0x00ul
#define _SD_ILDE_STATE      0x01ul
#define _SD_ERASE_RST       0x02ul
#define _SD_ILLEGAL_CMD     0x04ul
#define _SD_CRC_ERROR       0x08ul
#define _SD_ERASE_ERROR     0x10ul
#define _SD_ADD_ERROR       0x20ul
#define _SD_PARAM_ERROR     0x40ul

#define _SD_DATA_TOLKEN     0xFEul
#define _SD_DATA_ERR_TOLKEN 0x1Ful
#define _SD_STOP_TRAN       0xFDul
